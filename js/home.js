...
function NumeroALetras(num) {
  ...
  var montoInput = $('#monto-requerido')
  montoInput.on('keyup', function(){
    $(this).next('.input-success').text(jsUcfirst(NumeroALetras(this.value).toLowerCase()))

  })
  montoInput.on('change', formatCurrency)
  ...
  $("input[name='opcion-hipotecaria']").click(handleLoadForm)
  ...
  function handleLoadForm() {
    ...
    divPropuestas.innerHTML = '' // quito propuestas si cambia de menu
      ...
      const montoCredito = document.getElementById('montoCredito');
      ...
      $('html, body').animate({ scrollTop: $('.menu_credit_type').offset().bottom }, 'slow');
  ...
  function calculoYMuestroPropuestas (datos) {
    ...
    $('html, body').animate({ scrollTop: $('#propuestas-cotizador').offset().top }, 'slow');
  }
